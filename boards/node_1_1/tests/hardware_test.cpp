...
#include "gpos/hardware/boards/node_1_1/board_node_1_1.h"
...
class Node11HardwareTestCase : public TestCase
{
protected:

	Node11HardwareTestCase()
	{
	}
};
 ...
 */
TEST(Node11HardwareTestCase, LEDsOk)
{
 ...
 */
TEST(Node11HardwareTestCase, LCDOk)
{
 ...
 */
TEST(Node11HardwareTestCase, ScrollButtonOk)
{
 ...
 */
TEST(Node11HardwareTestCase, CoverTamperButtonOk)
{
 ...
 */
TEST(Node11HardwareTestCase, ExternalFlashPresent)
{
 ...
 */
TEST(Node11HardwareTestCase, RFModuleOk)
{
...
class Node11HardwareTest: public UnitTest
{
public:
	LEDsOk test1;
	LCDOk test2;
	...
	Node11HardwareTest::Node11HardwareTest()
